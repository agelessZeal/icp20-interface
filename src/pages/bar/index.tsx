...
import { SUSHI, XSUSHI, LICP, ST_ICP, ICP20 } from '../../config/tokens'
...
function Stake() {
  ...
  const balance = activeTab === 0 ? icp20Balance : stICPBalance
    ...
    <Container id="bar-page" className="py-4 md:py-8 lg:py-12" maxWidth="full">
      <Head>
        ...
        <meta
          key="description"
          name="description"
          content="Stake ICP-20 in return for st-ICP, an interest bearing and fungible ERC20 token designed to share revenue generated by all ICP-20 products."
        />
        <meta key="twitter:url" name="twitter:url" content="https://app.sushi.com/stake" />
        <meta key="twitter:title" name="twitter:title" content="STAKE ICP-20" />
        <meta
        ...
        <meta key="og:title" property="og:title" content="STAKE ICP-20" />
        ...
        <div className="flex justify-center mb-6">
          <div className="flex flex-col w-full max-w-xl mt-auto mb-2">
            ...
            {/* <div className="max-w-lg pr-3 mb-2 text-sm leading-5 text-gray-500 md:text-base md:mb-4 md:pr-0">
              {i18n._(t`For every swap on the exchange on every chain, 0.05% of the swap fees are distributed as ICP-20
                                proportional to your share of the ICPBar. When your ICP-20 is staked into the ICPBar, you receive
                                ...
                                ICP-20 and any additional from fees.`)}
            </div> */}
            {/* <div className="flex">
                ...
                <div className="relative w-full h-0 pointer-events-none bottom-14">
                  ...
                  >
                    <div className="flex space-x-2 ">
                      ...
                      >
                        {`${input ? input : '0'} ${activeTab === 0 ? 'ICP-20' : 'st-ICP'}`}
                      </p>
                    </div>
